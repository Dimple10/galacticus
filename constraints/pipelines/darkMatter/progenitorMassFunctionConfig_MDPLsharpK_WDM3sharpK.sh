#!/bin/bash
#PBS -N MDPlsharpK_WDM3sharpK
#PBS -l nodes=4:ppn=16
#PBS -j oe
#PBS -o MDPlsharpK_WDM3sharpK.log
...
/usr/bin/time -v mpirun --n 64 --map-by node --bind-to none -mca btl ^openib ./Galacticus.exe constraints/pipelines/darkMatter/progenitorMassFunctionConfig_MDPLsharpK_WDM3sharpK.xml
exit
