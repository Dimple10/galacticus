#!/bin/bash
#PBS -N binomial_MDPLsk_SymMWsk_FDMallsk
#PBS -l nodes=4:ppn=16
#PBS -j oe
#PBS -o binomialLikelihood_MDPLsk_SymMWsk_FDMallsk_run2.log
...
/usr/bin/time -v mpirun --n 64 --map-by node --bind-to none -mca btl ^openib ./Galacticus.exe constraints/pipelines/darkMatter/progenitorMassFunctionConfig_MDPLsk_SymphonyMWsk_FDMallsk.xml
exit
