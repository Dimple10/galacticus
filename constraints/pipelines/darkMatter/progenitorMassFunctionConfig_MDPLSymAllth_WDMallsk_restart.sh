#!/bin/bash
#PBS -N th_MDPLSymAll_WDMallsk
#PBS -l nodes=8:ppn=8
#PBS -j oe
#PBS -o MDPLSymAllth_WDMallsk.log
...
/usr/bin/time -v mpirun --n 64 --map-by node --bind-to none -mca btl ^openib ./Galacticus.exe constraints/pipelines/darkMatter/progenitorMassFunctionConfig_MDPLSymAllth_WDMallsk_restart.xml
exit
