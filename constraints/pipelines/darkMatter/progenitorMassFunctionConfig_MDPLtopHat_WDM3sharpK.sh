#!/bin/bash
#PBS -N MDPLtopHatWDM3sharpK
#PBS -l nodes=4:ppn=16
#PBS -j oe
#PBS -o MDPltopHat_WDM3sharpK.log
...
/usr/bin/time -v mpirun --n 64 --map-by node --bind-to none -mca btl ^openib ./Galacticus.exe constraints/pipelines/darkMatter/progenitorMassFunctionConfig_MDPLtopHat_WDM3sharpK.xml
exit
