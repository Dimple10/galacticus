#!/bin/bash
#PBS -N MDPlth_SymMWth_WDMallsk
#PBS -l nodes=4:ppn=16
#PBS -j oe
#PBS -o MDPlth_SymMWth_WDMallsk.log
...
/usr/bin/time -v mpirun --n 64 --map-by node --bind-to none -mca btl ^openib ./Galacticus.exe constraints/pipelines/darkMatter/progenitorMassFunctionConfig_MDPLth_SymphonyMWth_WDMallsk.xml
exit
