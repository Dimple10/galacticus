...
/usr/bin/time -v mpirun --n 16 --map-by node --bind-to none -mca btl ^openib ./Galacticus.exe constraints/pipelines/darkMatter/progenitorMassFunctionConfig_MDPLTest.xml
exit
