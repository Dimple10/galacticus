#!/bin/bash
#PBS -N MDPlsk_SymMWsk_WDMallsk
#PBS -l nodes=4:ppn=16
#PBS -j oe
#PBS -o MDPlsk_SymMWsk_WDMallsk.log
...
/usr/bin/time -v mpirun --n 64 --map-by node --bind-to none -mca btl ^openib ./Galacticus.exe constraints/pipelines/darkMatter/progenitorMassFunctionConfig_MDPLsk_SymphonyMWsk_WDMallsk.xml
exit
