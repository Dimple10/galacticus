#!/bin/bash
#PBS -N binomial_MDPLth_SymMWth_FDMallth
#PBS -l nodes=4:ppn=16
#PBS -j oe
#PBS -o binomialLikelihood_MDPLth_SymMWth_FDMallth_run2.log
...
/usr/bin/time -v mpirun --n 64 --map-by node --bind-to none -mca btl ^openib ./Galacticus.exe constraints/pipelines/darkMatter/progenitorMassFunctionConfig_MDPLth_SymMWth_FDMallth.xml
exit
